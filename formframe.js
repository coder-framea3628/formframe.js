...
function startChat() {
  ...
  setTimeout(() => {
    ...
    typeChatMessage('Olá! Tudo bem? Vi que você tem interesse nos serviços da Frame.', () => {
      showTypingIndicator();
      setTimeout(() => {
        removeTypingIndicator();
    ...
    if (input.value.trim()) {
      if (type === 'name') {
        ...
        if (validateCNPJ(cnpj)) {
          ...
          sendBtn.disabled = true;
          showLoadingInChat();
          fetchCompanyData(cnpj).then((data) => {
            ...
            showChatMessage('Erro ao consultar CNPJ. Prosseguindo sem auto-preenchimento.');
            setTimeout(() => {
              chatContainer.style.display = 'none';
              formContainer.style.display = 'block';
...
// Fetch company data from Receita Federal API
...
function renderForm() {
  ...
  form.innerHTML = `
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <input type="email" id="email" placeholder="email@dominio.com.br" required aria-required="true">
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <input type="text" id="website" placeholder="Digite o domínio..." required aria-required="true">
      </div>
      <div class="form-group">
  ...
  // Validação visual em tempo real (exemplo para email)
