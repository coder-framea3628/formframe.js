...
<div class="container">
  ...
  <div class="success-container">
    ...
    <button class="back-btn">Voltar ao site</button>
    <p>ou se preferir, <a class="email-link" href="mailto:contact@weframe.com.br">envie um e-mail para contact@weframe.com.br</a></p>
  </div>
...
<div class="loading-overlay">
  ...
  <p class="loading-text">Preparando as informações para desenvolver uma estrutura digital robusta para você...</p>
</div>
`;
    ...
    if (input.value.trim()) {
      if (type === 'name') {
        ...
        if (validateCNPJ(cnpj)) {
          ...
          showChatMessage('CNPJ inválido. Por favor, tente novamente no formato correto.');
        }
      }
    }
  }
...
function renderForm() {
  ...
  form.innerHTML = `
    ...
    <div class="checkbox-group">
      <label>
        ...
        Concordo em receber comunicações da Frame e que os dados inseridos serão utilizado para possibilitar o contato e serviços que possam ser do meu interesse.
      </label>
    </div>
  ...
  websiteInput.addEventListener('input', () => {
    ...
    if (!websiteInput.validity.valid) {
      group.classList.add('invalid');
      error.textContent = 'Site inválido.';
    } else {
      group.classList.remove('invalid');
      error.textContent = '';
    }
